...
const Contact = () => {
  return (
    <div className="outlet--container">
      <div className="mx-auto w-full h-full max-w-7xl px-5 py-4 md:px-10 md:py-8 lg:py-12">
        {/* <!-- Component --> */}
        <div className="grid h-full items-center gap-8 sm:gap-20 lg:grid-cols-2">
          {/* <!-- Contact Text --> */}
          ...
          <div className="mx-auto max-w-xl bg-[#f2f2f7] p-8 text-center">
            ...
            >
              ...
              <div className="mb-8 flex flex-col gap-y-2">
                <label for="field-3" className="mb- font-medium">
                  Project Brief
                </label>
                <textarea
                  placeholder=""
